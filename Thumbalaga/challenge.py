...
Enemy types per challenge stage (confirmed from real game):
  Stage  3: Bee          Stage 19: Galaxian
  Stage  7: Butterfly    Stage 23: Bosconian
  Stage 11: Dragonfly    Stage 27: Enterprise
...
_CP6 = [(-34,-70), (-34,-58), (-34,-45), (-33,-32), (-31,-20), (-29,-7), (-25,6), (-20,18), (-14,30), (-5,35), (6,33), (13,24), (11,15), (1,8), (-9,1), (-19,-6), (-29,-13), (-39,-20), (-49,-27), (-59,-34), (-69,-41), (-78,-48), (-88,-55)]
_CP6M = [(34,-70), (34,-58), (34,-45), (33,-32), (31,-20), (29,-7), (25,6), (20,18), (14,30), (5,35), (-6,33), (-13,24), (-11,15), (-1,8), (9,1), (19,-6), (29,-13), (39,-20), (49,-27), (59,-34), (69,-41), (78,-48), (88,-55)]
_CP7 = [(-64,35), (-49,34), (-33,29), (-18,23), (-4,13), (8,1), (16,-16), (16,-36), (15,-56), (7,-70), (1,-54), (1,-34), (2,-13), (16,-12), (34,-11), (51,-9), (69,-8), (86,-7)]
_CP7M = [(64,35), (49,34), (33,29), (18,23), (4,13), (-8,1), (-16,-16), (-16,-36), (-15,-56), (-7,-70), (-1,-54), (-1,-34), (-2,-13), (-16,-12), (-34,-11), (-51,-9), (-69,-8), (-86,-7)]
_CP8 = [(-34,-70), (-34,-55), (-34,-40), (-34,-26), (-32,-10), (-30,6), (-28,20), (-24,35), (-24,34), (-28,18), (-31,3), (-32,-12), (-33,-27), (-34,-44), (-35,-58), (-36,-73), (-37,-87)]
_CP8M = [(34,-70), (34,-55), (34,-40), (34,-26), (32,-10), (30,6), (28,20), (24,35), (24,34), (28,18), (31,3), (32,-12), (33,-27), (34,-44), (35,-58), (36,-73), (37,-87)]
...
_CP13 = [(-64,24), (-45,-16), (-32,-65), (-15,-39), (-37,-38), (-13,-68), (1,-26), (-19,-35), (4,-64), (18,-20), (-1,-40), (20,-48), (38,-2), (63,35), (88,72)]
_CP13M = [(64,24), (45,-16), (32,-65), (15,-39), (37,-38), (13,-68), (-1,-26), (19,-35), (-4,-64), (-18,-20), (1,-40), (-20,-48), (-38,-2), (-63,35), (-88,72)]
...
_CP19 = [(-64,31), (-48,23), (-37,1), (-36,-27), (-36,-54), (-27,-70), (-12,-52), (5,-51), (20,-68), (29,-51), (28,-24), (28,4), (38,26), (56,35), (76,45), (97,55)]
_CP19M = [(64,31), (48,23), (37,1), (36,-27), (36,-54), (27,-70), (12,-52), (-5,-51), (-20,-68), (-29,-51), (-28,-24), (-28,4), (-38,26), (-56,35), (-76,45), (-97,55)]
_CP20 = [(-34,-70), (-34,-48), (-41,-27), (-63,-35), (-48,-50), (-34,-33), (-30,-11), (-18,8), (5,14), (4,-6), (-18,0), (-8,20), (15,32), (42,35), (65,38), (88,40)]
_CP20M = [(34,-70), (34,-48), (41,-27), (63,-35), (48,-50), (34,-33), (30,-11), (18,8), (-5,14), (-4,-6), (18,0), (8,20), (-15,32), (-42,35), (-65,38), (-88,40)]
_CP21 = [(-64,35), (-51,34), (-37,29), (-24,22), (-11,11), (1,-2), (12,-19), (17,-42), (12,-64), (-2,-69), (-12,-52), (-9,-28), (4,-19), (15,-32), (27,-46), (38,-60), (50,-73), (62,-87)]
_CP21M = [(64,35), (51,34), (37,29), (24,22), (11,11), (-1,-2), (-12,-19), (-17,-42), (-12,-64), (2,-69), (12,-52), (9,-28), (-4,-19), (-15,-32), (-27,-46), (-38,-60), (-50,-73), (-62,-87)]
...
_CHALLENGE_ENEMY_TYPE = [
    ...
    ENEMY_DRAGONFLY,  # config 2 (stage 11)
    ENEMY_SCORPION,   # config 3 (stage 15)
    ENEMY_GALAXIAN,   # config 4 (stage 19)
    ENEMY_BOSCONIAN,  # config 5 (stage 23)
    ENEMY_ENTERPRISE, # config 6 (stage 27)
...
CHALLENGE_PATH_DURATION = 2.2  # seconds to traverse path
    ...
    def init(self, enemy_nodes, stage=3):
        ...
        for wave_idx in range(CHALLENGE_WAVE_COUNT):
            ...
            for i in range(CHALLENGE_ENEMIES_PER_WAVE):
                ...
                # Wave 2 (index 1): alternating bosses and main type
                if wave_idx == 1 and i % 2 == 0:
                    this_type = ENEMY_BOSS
                else:
                    this_type = etype
                ce._etype = this_type
                ...
                # Set sprite type
                ce.node.frame_current_y = this_type
                ia, ib = get_idle_frames(this_type)
